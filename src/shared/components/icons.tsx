import type { OsKind } from "../types/device";
...
export function DeviceKindIcon({ os, className }: { os: OsKind; className?: string }) {
  if (os === "android") return <PhoneIcon className={className} />;
